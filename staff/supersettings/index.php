				...
				<div class="inner">
					...
					<section id="home-section">
						<div id="container03" class="container columns full">
							<div class="inner">
								<div>
									<p id="text12">Current CAD Supervisors</p>
								...
								<div>
									...
									<form enctype="multipart/form-data" id="form02" method="post" action="../../backend/createAdmin.php" autocomplete="off">
										<div class="inner">
											<div class="field">
												<input type="text" name="sname" id="form02-display-name" placeholder="Display Name" maxlength="128" required />
											</div>
											<div class="field">
												<input type="text" name="id" id="form02-discord-user-id" placeholder="User ID" maxlength="128" required />
											</div>
											<div class="actions">
