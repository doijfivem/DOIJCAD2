...
<html lang="en">
	<head>
		<title><?php fetchSetting('nameSml');?> - Register</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				<div class="inner">
					...
					<section id="home-section">
						<h2 id="text09"><?php fetchSetting('nameSml');?> CAD Register</h2>
						<p id="text11"><a href="/login">Already have an account? Login!</a></p>
						<hr id="divider02">
						<?php if(get('err')) { ?>
							<p id="text11"><strong><span style="color: #E8596E"><?php echo get('err'); ?></span></strong></p>
						<?php } ?>
						<form enctype="multipart/form-data" id="form01" method="post" action="../backend/register.php" autocomplete="off">
							<div class="inner">
								<div class="field">
