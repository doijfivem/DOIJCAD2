...
<html lang="en">
	<head>
		<title><?php fetchSetting('nameSml');?> - Law Enforcement Name Search</title>
		<meta charset="utf-8" />
								...
								<div>
									...
									<ul id="buttons07" class="buttons">
										<li>
											...
											<a href="../ct/?id=<?php echo $redirId; ?>" class="button n02"><svg><use xlink:href="../../assets/icons.svg#document-alt"></use></svg><span class="label">Create Ticket</span></a>
										</li><li>
											<a href="../ca/?id=<?php echo $redirId; ?>" class="button n03"><svg><use xlink:href="../../assets/icons.svg#document"></use></svg><span class="label">Create Arrest</span></a>
										</li>
									</ul>
								</div>
								<div>
