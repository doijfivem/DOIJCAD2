...
?>
    ...
    <ul id="buttons12" class="buttons">
        <li>
            <a class="button n01"><svg><use xlink:href="../assets/icons.svg#location"></use></svg><span class="label">Panic Button Pressed By: &#39;<?php echo getPanicStatus($server)['name']; ?>&#39;</span></a>
        </li>
    </ul>
<?php
}
